  ...
  task :add_questions => :environment do
	...
	# The Michael Scott Syndrome (Self-Awareness)
		...
		[
			...
			:upper_title => "Frequently",
			:lower_title => "Not at all",
			:category_title => "The Michael Scott Syndrome (Self-Awareness)"
		],
		[
			...
			:upper_title => "Definitely",
			:lower_title => "Definitely Not",
			:category_title => "The Michael Scott Syndrome (Self-Awareness)"
		],
		[
			...
			:upper_title => "Defensive/Closed",
			:lower_title => "Interested/Open",
			:category_title => "The Michael Scott Syndrome (Self-Awareness)"
		],
		[
			...
			:upper_title => "Pause to examine",
			:lower_title => "Quickly move on",
			:category_title => "The Michael Scott Syndrome (Self-Awareness)"
		],
		[
			...
			:upper_title => "Very Surprised",
			:lower_title => "Unphased",
			:category_title => "The Michael Scott Syndrome (Self-Awareness)"
		],
	# The Story Collector
		[
